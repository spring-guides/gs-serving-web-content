...
This guide walks you through the process of creating a "`Hello, World`" website with Spring.
...
You can use this https://start.spring.io/#!type=gradle-project&jvmVersion=17&packaging=jar&groupId=com.example&artifactId=serving-web-content&packageName=com.example.servingwebcontent&dependencies=web,thymeleaf,devtools[pre-initialized project] and click Generate to download a ZIP file. This project is configured to fit the examples in this tutorial.
...
In Spring's approach to building websites, HTTP requests are handled by a controller. You
...
rendering the HTML content. The following listing shows the controller:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/servingwebcontent/GreetingController.kt[]
----
...
TIP: Make sure you have Thymeleaf on your classpath (artifact co-ordinates: `org.springframework.boot:spring-boot-starter-thymeleaf`). It is already there in the "initial", "complete", "initial-kotlin", and "complete-kotlin" samples in GitHub.
...
further modify the class provided by the Spring Initializr. The following listing shows the
application class:
...
.Kotlin
----
include::complete-kotlin/src/main/kotlin/com/example/servingwebcontent/ServingWebContentApplication.kt[]
----
...
Now that the website is running, visit `http://localhost:8080/greeting`, where you should
see "`Hello, World!`"
...
the controller is working as expected. The `name` parameter has been given a default
